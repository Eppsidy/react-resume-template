...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="bg-cyber-black" sectionId={SectionId.Contact}>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-300 hover:text-cyber-blue-dark focus:outline-none focus:ring-2 focus:ring-cyber-blue-dark',
